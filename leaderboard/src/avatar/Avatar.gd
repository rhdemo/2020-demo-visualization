...
func _ready():
	...
	$AvatarUIContainer/AvatarGuessContainer/CorrectContainer/CorrectPanel/CorrectMargins/Correct.text = String(NumCorrect)
	$AvatarUIContainer/AvatarGuessContainer/IncorrectContainer/IncorrectPanel/IncorrectMargins/Incorrect.text = String(NumIncorrect)
	$AvatarUIContainer/ScoreContainer/ScorePanel/Score.text = String(NumScore)
